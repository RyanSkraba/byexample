package com.skraba.byexample.scala.hack.advent2025

import com.skraba.byexample.scala.hack.advent2025.AdventUtils._
import org.scalatest.BeforeAndAfterEach
import org.scalatest.funspec.AnyFunSpecLike
import org.scalatest.matchers.should.Matchers

/** =Advent of Code 2025 Day 0 Solutions in scala=
  *
  * Input:
  *
  * Part 1:
  ...
  *
  * @see
  *   Rephrased from [[https://adventofcode.com/2025/day/0]]
  */
class AdventOfCodeDay0Spec extends AnyFunSpecLike with Matchers with BeforeAndAfterEach {
  ...
  describe("🔑 Solution 🔑") {
    lazy val input = puzzleInput("Day0Input.txt")
