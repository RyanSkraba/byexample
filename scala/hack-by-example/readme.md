...
| 🔶[Day 7][AoC2023-07] ([Solution][Sol-AoC2023-07])   | 💜️ Implementing a custom ordering for card hands.                                                                                                                                                                                                                                            |
...
| 🟥[Day 10][AoC2023-10] ([Solution][Sol-AoC2023-10])️ | 💜️ 2D map of characters again: a long connected pipe shape.  Solved with regexes. A bit trickier but fell on the right approach early and had fun.                                                                                                                                           |
...
| 🟥[Day 12][AoC2023-12] ([Solution][Sol-AoC2023-12])  | 💜️ Fun! Started with a recursive search for Part 1, and added a memo (dynamic programming for part 2). It took some work to get the stopping conditions correct.                                                                                                                             |
...
| 🔶[Day 14][AoC2023-14] ([Solution][Sol-AoC2023-14])  | 💜️ Another 2D map of characters.  Part 2 was to find and skip over the repeating cycle, and my `LazyList` implementation was pretty fun.                                                                                                                                                     |
...
| 🔶[Day 18][AoC2023-18] ([Solution][Sol-AoC2023-18])  | 💜️ Fun! Part 1 was a building a 2D plan from directions, and then flood-fill, but I implemented Part 2 with a scan line.  It looks like a lot of people used Shoelace Formula to calculate the area in a polygon, and Pick's Theorem for points inside a polygon.                            |
