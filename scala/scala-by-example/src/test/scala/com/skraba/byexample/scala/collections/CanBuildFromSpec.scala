...
class CanBuildFromSpec extends AnyFunSpecLike with Matchers {
  ...
  describe("BuildFrom") {
    ...
    it("is used to ensure that a String can be mapped to a String") {
      ...
      val scbf: BuildFrom[String, Char, String] = implicitly
      scbf shouldBe BuildFrom.buildFromString
    }
  }
  ...
  describe("MagicList") {
    ...
    it("looks like a Seq but doesn't have the same magic") {
      ...
      "implicitly[BuildFrom[MagicList, Boolean, MagicList]]" shouldNot compile
    }
